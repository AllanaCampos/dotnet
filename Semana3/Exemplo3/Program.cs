...
var students = new List<Student>{
   new Student(1, "Allana Campos", "123456789", new DateTime(1999, 3, 10), new List<string>{"123456789", "73988342986"}),
   new Student(2, "Alexsandra Campos", "987654321", new DateTime(1997, 7, 12), new List<string>{"123456789", "73987654321"}),
   new Student(3, "Marineide Calhau", "123456789", new DateTime(1972, 7, 10), new List<string>{"123456789", "77988237086"}),
   new Student(4, "Orlando Campos", "123456789", new DateTime(1964, 10, 01), new List<string>{"123456789", "77988237086"})
};

var any = students.Any();
var anyHelder = students.Any(x => x.FullName.Contains("Allana"));
